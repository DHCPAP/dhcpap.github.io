# -*- coding: utf-8 -*-
#
# DHCPAP documentation build configuration file, created by
...
# of the sidebar.
#
# html_logo = 'images/dhcpcanon_logo.png'

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#
html_favicon = 'images/dhcpcanon.ico'
...
latex_documents = [
    (master_doc, 'DHCPAP.tex', u'DHCPAP Documentation',
     u'juga', 'manual'),
]
...
man_pages = [
    (master_doc, 'dhcpap', u'DHCPAP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DHCPAP', u'DHCPAP Documentation',
     author, 'DHCPAP', 'One line description of project.',
     'Miscellaneous'),
]
